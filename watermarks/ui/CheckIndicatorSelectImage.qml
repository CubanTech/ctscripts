...
Rectangle {
    ...
    implicitHeight: 18
    color: "transparent"
    border.color: !control.enabled ? "transparent"
        : checkState !== Qt.Unchecked ? control.Material.accentColor : "transparent"
    ...
    Image {
        ...
        width: 48
        height: 48
        source: "qrc:/images/icons/check.png"
